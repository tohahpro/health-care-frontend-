              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                {buttons.primary && (
                  <Button
                    ...
                    className="h-[63.622px] cursor-pointer gap-3 rounded-xl bg-blue-600 px-8 text-[15.3px] hover:bg-blue-700"
                  >
                ...
                {buttons.secondary && (
                  <Button
                    ...
                    variant="outline"
                    className="h-[63.622px] cursor-pointer gap-3 rounded-xl border-blue-600 px-8 text-[15.3px] text-blue-600 hover:bg-blue-50"
                  >
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                ...
                <form className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="h-[59.986px] w-full cursor-pointer rounded-xl bg-blue-600 text-[15.3px] hover:bg-blue-700"
                  >
                    {formCard.submitText}
                  </Button>
                </form>
